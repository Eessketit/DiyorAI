...
export const translations: Record<Language, Translations> = {
  ...
  uz: {
    ...
    regions: {
      ...
      termez: "Termiz",
      nukus: "Qoraqalpog'iston (Nukus / Orol)",
      navoi: "Navoiy (Nurota)",
      jizzakh: "Jizzax (Zomin)",
      syrdarya: "Sirdaryo (Guliston)",
    },
    paces: {
  ...
  en: {
    ...
    regions: {
      ...
      shahrisabz: "Shahrisabz",
      termez: "Termez",
      nukus: "Karakalpakstan (Nukus / Aral)",
      navoi: "Navoi (Nurata)",
      jizzakh: "Jizzakh (Zaamin)",
      syrdarya: "Syrdarya (Gulistan)",
    },
    paces: {
